...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dry-block-015f
```

## Preview Deployment

A live public deployment of this template is available at [https://dry-block-015f.templates.workers.dev](https://dry-block-015f.templates.workers.dev)
